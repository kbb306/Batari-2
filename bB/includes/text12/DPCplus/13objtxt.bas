...
__Start_Restart
   ...
   player2x = 77 : player2y = player1y + 17
   player3x = 77 : player3y = player2y + 17
   player4x = 77 : player4y = player3y + 17
   player5x = 77 : player5y = player4y + 17
   player6x = 77 : player6y = player5y + 17
   player7x = 77 : player7y = player6y + 17
   player8x = 77 : player8y = player7y + 17
   player9x = 98 : player9y = 0
   missile0x = 98 : missile0y = player9y + 17
   missile1x = 98 : missile1y = missile0y + 17
   ballx = 98 : bally = missile1y + 17
...
__Skip_Fire_Button
   ...
   if joy0down then if player0y <= 146 then player0y = player0y + 1
...
__Skip_Sprite0_Movement
   ...
   if joy0down then if player1y <= 146 then player1y = player1y + 1
...
__Skip_Sprite1_Movement
   ...
   if joy0down then if player2y <= 146 then player2y = player2y + 1
...
__Skip_Sprite2_Movement
   ...
   if joy0down then if player3y <= 146 then player3y = player3y + 1
...
__Skip_Sprite3_Movement
   ...
   if joy0down then if player4y <= 146 then player4y = player4y + 1
...
__Skip_Sprite4_Movement
   ...
   if joy0down then if player5y <= 146 then player5y = player5y + 1
...
__Skip_Sprite5_Movement
   ...
   if joy0down then if player6y <= 146 then player6y = player6y + 1
...
__Skip_Sprite6_Movement
   ...
   if joy0down then if player7y <= 146 then player7y = player7y + 1
...
__Skip_Sprite7_Movement
   ...
   if joy0down then if player8y <= 146 then player8y = player8y + 1
...
__Skip_Sprite8_Movement
   ...
   if joy0down then if player9y <= 146 then player9y = player9y + 1
...
__B
   ...
   __P, __6, _sp, _lp, __V, __I, __R, __T, __U, __A, __L, _rp
   __P, __7, _sp, _lp, __V, __I, __R, __T, __U, __A, __L, _rp
   __P, __8, _sp, _lp, __V, __I, __R, __T, __U, __A, __L, _rp
   __P, __9, _sp, _lp, __V, __I, __R, __T, __U, __A, __L, _rp
