...
mainloop
 ...
 if joy0left then BaudByte{0} = !BaudByte{0} : goto waitleft
 if joy0right then BaudByte{1} = !BaudByte{1} : goto waitright
 if joy0up then BaudByte{2} = !BaudByte{2} : goto waitup
 if joy0down then BaudByte{3} = !BaudByte{3} : goto waitdown
 if joy0fire then BaudByte{4} = !BaudByte{4} : goto waitfire
...
commit
 ...
 if index = 27 then ShiftMode = 1 : goto waitcommit
 if index = 31 then ShiftMode = 0 : goto waitcommit
